...
void setup(void){
  ...
  message += "</style></head><body class=\"" + cssClass + "\"><div><h2>" + title +  "</h2><h4>Время работы:" + hr + ":" + min % 60 + ":" + sec % 60 +" </h4><h3>Температура: " + temp_str + "&nbsp;<small>&deg;C</small></h3><h3>Влажность: " + hum_str + "&nbsp;%</h3><h3>Обогрев: " + heat_str + "&nbsp;</h3></div></body></html>"; //ru
